...
The original and updated versions should both remain discoverable. Existing projects using the original bank should remain reproducible, while new projects can use Akane Iirai as the current revision.
